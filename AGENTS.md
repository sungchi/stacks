...
**매시간 같은 0~9 카드 40장에 도전해 네 장 합과 시계방향 정원 연결 배수로 별을 얻는 모바일 우선 정적 웹 카드 게임.**
...
| [docs/analysis/garden-stacks-hourly-four-harvest-concept-2026-07-13.md](docs/analysis/garden-stacks-hourly-four-harvest-concept-2026-07-13.md) | seed 일러스트·네 장 합·시계방향 정원 연결 배수·시간 도전 제안 | 제안 |
...
- 기본 플레이 진입은 KST 시간 seed의 네 정원 수확이며, 기존 무한 정원과 캠페인은 명시적 모드 주소로 접근한다.
...
- `simple/` UI는 시간 정원의 기본 플레이 화면이며 별 목표·4정원·손패·다시하기·공유·수동 새 시간 전환만 남긴다.
